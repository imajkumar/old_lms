...
function get_client_contact_merge_fields($client_id, $contact_id = '', $password = '')
{
    ...
    $fields['{client_city}']        = $CI->leads_model->get_city_name($client->city);
    $fields['{client_zip}']         = $client->zip;
    $fields['{client_state}']       = $CI->leads_model->get_state_name($client->state);
...
function get_staff_merge_fields($staff_id, $password = '')
{
    ...
    $fields['{staff_emp_code}']    = $staff->emp_code;
    $fields['{staff_datecreated}'] = $staff->datecreated;
 $fields['{staff_reporting_manager}'] = $staff->reporting_manager;
