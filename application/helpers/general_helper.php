...
/**
 * Return logged staff State from session
 * @return mixed
 */
function get_staff_state_id()
{
    $CI =& get_instance();
    if (!$CI->session->has_userdata('staff_logged_in')) {
        return false;
    ...
    return $CI->session->userdata('staff_state');
}

function get_staff_email_id()
{
    $CI =& get_instance();
    if (!$CI->session->has_userdata('staff_logged_in')) {
        return false;
    ...
    return $CI->session->userdata('staff_email');
}
...
function get_staff_role()
{
    ...
    return $CI->session->userdata('staff_role');
}
function get_staff_reporting_to()
{
    $CI =& get_instance();
    if (!$CI->session->has_userdata('staff_reporting_to')) {
        return false;
    }

    return $CI->session->userdata('staff_reporting_to');
}
/**
