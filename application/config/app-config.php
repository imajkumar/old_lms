...
define('APP_ENC_KEY','9ba072bcfcb6563a7a8ac9ebf8dbddc7');

/* Database credentials - Auto added on install */

/* The hostname of your database server. */
define('APP_DB_HOSTNAME','localhost');
//define('APP_DB_HOSTNAME','103.80.67.156');
/* The username used to connect to the database */
define('APP_DB_USERNAME','root');
//define('APP_DB_USERNAME','devhalonix');
/* The password used to connect to the database */
define('APP_DB_PASSWORD','sahaj');
//define('APP_DB_PASSWORD','devhalonix');
