...
class Knowledge_base extends Admin_controller
{
    ...
    public function index()
    {
		...
		$data['article_list'] = $this->knowledge_base_model->get();
    ...
    public function article($id = '')
    {
        ...
        if ($this->input->post()) {
			...
			if (isset($_FILES["profile_image"]) && !empty($_FILES['profile_image']['name'])) {
                ...
                $img_name = $uploaddir . basename($_FILES['profile_image']['name']);
                move_uploaded_file($_FILES["profile_image"]["tmp_name"], $img_name);
            } 
			
			 $data                = $this->input->post();
             $data['description'] = $this->input->post('description', false); 
			 $data['image'] = basename($_FILES['profile_image']['name']);
            if ($id == '') {
    ...
    {
		$data['id']=$id;
		 $data['get_knowledge'] = $this->knowledge_base_model->update_kan_ban($id);
		
     $this->load->view('admin/knowledge_base/edit_articles', $data); 
 ...
 $data_array = array (
			...
			'image' => $this->input->file('profile_image'),
	...
	public function download($id){
        if(!empty($id)){
            ...
            //file path
            $file = 'uploads/files/'.$fileInfo['image'];
