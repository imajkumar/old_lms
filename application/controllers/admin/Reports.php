...
/*
	...
	public function pipeline_report()
    {
		...
		if(is_admin() || get_staff_role() >= 8 ){
			...
			$this->load->view('admin/reports/pipeline-report-dynsm', $data);
		}else if(get_staff_role() == 2){
			$this->load->view('admin/reports/pipeline-report-rsm', $data);
		}else if(get_staff_role() == 5){
			$this->load->view('admin/reports/pipeline-report-zsm', $data);
		}else if(get_staff_role() == 3){
			$this->load->view('admin/reports/pipeline-report-asm', $data);
		}
    }
	public function winloss_report()
    {
        $type = 'leads';
        if ($this->input->post()) {
		...
		if(is_admin() || get_staff_role() >= 8 ){
			$this->load->view('admin/reports/winloss-report', $data);
		}else if(get_staff_role() == 6){
			$this->load->view('admin/reports/winloss-report-6', $data);
		}else if(get_staff_role() == 2){
			$this->load->view('admin/reports/winloss-report-2', $data);
		}else if(get_staff_role() == 5){
			$this->load->view('admin/reports/winloss-report-5', $data);
		}else if(get_staff_role() == 3){
    ...
    public function get_opportunity_sum($staff_id=''){
		echo $this->leads_model->get_opportunity_sum($staff_id);
	}
