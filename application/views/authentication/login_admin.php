   ...
   <div class="col-md-4 col-md-offset-8 authentication-form-wrapper">
    ...
    <div class="mtop40">
      ...
      <div class="form-group">
        <input type="text" id="email" name="email" placeholder="<?php echo _l('Employee Code'); ?>" class="form-control" autofocus="1">
      </div>
      <div class="form-group">
        <input type="password" id="password" placeholder="<?php echo _l('admin_auth_login_password'); ?>" name="password" class="form-control"></div>
        <div class="checkbox">
          <label for="remember">
