    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<?php echo render_input('itme_code','Item code'); ?>
                <?php echo render_input('unit','unit'); ?> 
                <?php echo render_input('stock','Stock'); ?> 
    ...
    $("body").on('show.bs.modal', '#sales_item_modal', function (event) {
        ...
        if (typeof (id) !== 'undefined') {
            ...
            requestGetJSON('invoice_items/get_item_by_id/' + id).done(function (response) {
				...
				$itemModal.find('input[name="itme_code"]').val(response.itme_code);
 ...
 $(document).on('change', '#group_id', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
				...
				div_data += "<option value='0'>Select Wattage</option>";
