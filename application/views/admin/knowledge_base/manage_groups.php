                ...
                <div class="panel_s">
                    <div class="panel-body">
                       <div class="_buttons">
                        ...
                        <div class="_buttons">
                            <a href="#" onclick="new_kb_group(); return false;" class="btn btn-default btn-icon pull-left display-block">
                                <?php echo _l('new_group'); ?>
                            </a>
                            <?php } ?>
                            <a href="<?php echo admin_url('knowledge_base'); ?>" class="btn btn-default btn-icon pull-left display-block">
