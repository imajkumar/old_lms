...
<div class="content">
  <div class="col-md-5" id="small-table">
	...
	<a href="" onclick="new_status(); return false;" class="btn btn-info pull-right display-block">
								Add Region							</a>
						</div>
        ...
        <div class="form-group" app-field-wrapper="firstname"><label for="firstname" class="control-label"> <small class="req text-danger">* </small>Region</label> <select class="selectpicker" data-none-selected-text="<?php echo _l('system_default_string'); ?>" data-width="100%" name="region" id="region">
...
<div class="btn-top-toolbar text-right">
         <button type="submit" class="btn1 btn-info" style="width: 75px;height: 34px;"><?php echo _l('submit'); ?></button>
      </div>
			 </form>
...
<div class="col-md-7" id="small-table">
  <div class="panel_s">
            <div class="panel-body1" style="background: #fff;">


<table class="table table-leads" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
...
<div class="modal fade" id="status" tabindex="-1" role="dialog">
   <div class="modal-dialog">
      <?php echo form_open(admin_url('region/edit_region/'.$get_region['id'])); ?>
