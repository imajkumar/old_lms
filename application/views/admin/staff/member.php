                  ...
                  <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                     ...
                     <div class="is-not-staff<?php if(isset($member) && $member->admin == 1){ echo ' hide'; } ?>">
                        <div class="checkbox checkbox-primary">
                           ...
                           <label for="is_not_staff"><?php echo 'Dummy Staff User'; ?></label>
                        </div>
                        <hr />
                     </div>
                     ...
                     <?php } ?>
                     <i class="fa fa-question-circle pull-left hidden" data-toggle="tooltip" data-title="<?php echo _l('staff_email_signature_help'); ?>"></i>
					 ...
					 <div class="form-group">
                       ...
                       <select  id="state_id" required name="state[]" multiple>
					     ...
					     <input type="hidden" value="validate" id="btn"/>
                     </div>
					 <div class="form-group">
                        <label for="Reporting"><small class="req text-danger">* </small><?php echo 'Reporting Manager'; ?></label>
                           ...
                           <option value="<?php echo $staff['staffid']; ?>" <?php if (set_value('staff',$staff['staffid']) == $member_list['reporting_manager']) {
                                        ...
                                        } ?> ><?php echo ucfirst($staff['emp_code'].' - '.$staff['firstname'].'  '.$staff['lastname']); ?>
							</option>
                           <?php } ?>
                        </select>
                     ...
                     <div class="input-group">
                        <input type="password" class="form-control password" pattern="(?=.\d)(?=.[a-z])(?=.*[A-Z])(?=.*?[#?!@$%^&*-]).{8,}" title="Password should be at least 8 characters, contain upper and lower case letters,number and symbols like ~ ! @ # $ % &" name="password" autocomplete="off">
                        <span class="input-group-addon">
                        ...
                        <table class="table table-bordered roles no-margin">
                           <thead>
                              <tr>
                                 ...
                                 <th class="text-center text-danger bold"><?php echo 'Approval'; ?></th>
                              </tr>
                           </thead>
                           <tbody>
                              <?php
                              ...
                              <tr data-id="<?php echo $permission['permissionid']; ?>" data-name="<?php echo $permission['shortname']; ?>">
								 ...
								 <td  class="text-center">
                                    <?php if($permission_condition['approval'] == true){
                                       $statement = '';
                                       if(isset($is_admin) && $is_admin){
                                         $statement = 'disabled';
                                       } else if(isset($member) && has_permission($permission['shortname'],$member->staffid,'approval')){
                                         $statement = 'checked';
                                       }
                                       ?>
                                    <div class="checkbox checkbox-danger">
                                       <input type="checkbox" data-shortname="<?php echo $permission['shortname']; ?>" data-can-approval <?php echo $statement; ?> name="approval[]" value="<?php echo $permission['permissionid']; ?>">
                                       <label></label>
                                    </div>
                                    <?php } ?>
                                 </td>
      ...
      <div class="col-md-7 small-table-right-col">
		 ...
		 <div class="panel_s hidden">
            <div class="panel-body">
               ...
               <div class="_filters _hidden_inputs hidden staff_leads_filter">
         ...
         <div class="panel_s">
            <div class="panel-body">
               ...
               <div class="mbot15 usernote hide inline-block full-width">
                  ...
                  <button class="btn btn-default pull-right mbot15"><?php echo _l('submit'); ?></button>
                  <?php echo form_close(); ?>
               </div>
               <div class="clearfix"></div>
               <div class="mtop15">
                           ...
                           <td width="50%">
                              ...
                              <div data-note-edit-textarea="<?php echo $note['id']; ?>" class="hide inline-block full-width">
                                 ...
                                 <div class="text-right mtop15">
                                    ...
                                    <button type="button" class="btn btn-default" onclick="edit_note(<?php echo $note['id']; ?>);"><?php echo _l('update_note'); ?></button>
                                 </div>
                              </div>
                           </td>
...
<script>
    ...
    $('#btn').click(function(){
        if ($("#state_id option:selected").length == 0) {
            alert('None Selected');
        }
    });
});
