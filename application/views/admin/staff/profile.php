        ...
        <div class="row">
            <div class="col-md-7">
                <div class="panel_s">
                    ...
                    <?php } ?>
                    <div class="form-group">
                        <label for="emp_code" class="control-label"><?php echo _l('Employee Code'); ?></label>
                        <input type="text" class="form-control" name="emp_code" value="<?php if(isset($member)){echo $member->emp_code; } ?>">
                    </div>
                    <div class="form-group">
             ...
             <?php } ?>
             <button type="submit" class="btn btn-default pull-right"><?php echo _l('submit'); ?></button>
             <?php echo form_close(); ?>
         </div>
     </div>
 </div>
