  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="row">
          <div class="col-md-12">
            <?php
			 ...
			 <!--<input type="hidden" name="assigned_person" value="<?php echo $assigned_person; ?>"/>
			 -->
      ...
      <div class="checkbox checkbox-primary no-mtop checkbox-inline task-add-edit-public hide">
        <input type="checkbox" id="task_is_public" name="is_public"  checked >
      ...
      <div class="hide task-visible-to-customer checkbox checkbox-inline checkbox-primary<?php if((isset($task) && $task->rel_type != 'project') || !isset($task) || (isset($task) && $task->rel_type == 'project' && total_rows('tblprojectsettings',array('project_id'=>$task->rel_id,'name'=>'view_tasks','value'=>0)) > 0)){echo ' hide';} ?>">
      ...
      <?php if(!isset($task)){ ?>
      <a href="#" class="pull-right hide" onclick="slideToggle('#new-task-attachments'); return false;">
    ...
    <?php echo render_textarea('name','Task Description',$value); ?>
    <div class="hide task-hours<?php if(isset($task) && $task->rel_type == 'project' && total_rows('tblprojects',array('id'=>$task->rel_id,'billing_type'=>3)) == 0){echo ' hide';} ?>">
      <?php $value = (isset($task) ? $task->hourly_rate : 0); ?>
      <?php echo render_input('hourly_rate','task_hourly_rate',$value); ?>
    </div>
    <div class="hide project-details<?php if($rel_type != 'project'){echo ' hide';} ?>">
      <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        ?>
        <?php echo render_date_input('startdate','Task Date',$value, $date_attrs); ?>
      </div>
...
<div class="hide recurring_custom <?php if((isset($task) && $task->custom_recurring != 1) || (!isset($task))){echo 'hide';} ?>">
 <div class="row">
  <div class="col-md-6">
...
<div id="hide recurring_ends_on" class="<?php if(!isset($task) || (isset($task) && $task->recurring == 0)){echo 'hide';}?>">
...
<p class="bold hide"><?php echo _l('task_add_edit_description'); ?></p>
