         ...
         <div class="col-md-12">
          <div class="panel_s">
			   ...
			   <div class="col-md-12">
				   ...
				   <div class="col-md-6">
						<a href="<?php echo base_url(); ?>/admin/Customer_transfer" class="btn btn-info pull-right display-block" >Customer Transfer</a>
				   </div>
				</div>
                  <div class="_buttons">
                  ...
                  <div class="tab-content">
                     ...
                     <div class="row" id="leads-table">
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 <p class="bold"><?php echo _l('Get Staff Lead'); ?></p>
                              </div>
							
							<form action="<?php echo base_url('admin/Lead_tansfer/'.$posts->assigned); ?>" class="region-form"  method="post"> 
                            ...
                            <div class="col-md-2 leads-filter-column">
							   <div class="_buttons">
								  ...
								  <input type="submit" value="<?php echo 'Fetch Leads'; ?>" class="btn mright5 btn-info pull-left display-block" class="checkbox mass_select_all_wrap">
								</div>    
                           </div>
						   
							</form>
						   
						    <form action="<?php echo base_url('admin/Lead_tansfer/lead_transfer_done'); ?>" class="region-form"  method="post"> 
						   <div class="col-md-2 leads-filter-column">
							   <div class="_buttons">
									Select Transfer To
								</div>    
					  ...
					  <th class="sorting_disabled  text-center" rowspan="1" colspan="1" aria-label="#">Lead ID</th>
					  <th class="sorting_disabled text-center" rowspan="1" colspan="1" aria-label="#">Created Date
					  
					  <th class="sorting_disabled text-center" rowspan="1" colspan="1" aria-label="#">Lead Description</th>
					  <th class="sorting_disabled text-center" rowspan="1" colspan="1" aria-label="#">Opportunity(In Lacs)</th>
					  <th class="sorting_disabled text-center" rowspan="1" colspan="1" aria-label="#">Transfer To</th>
						...
						$i=0;
						 ...
						 
						 {
							 ?>
						 <tr>
						 <td><input class="checkboxall"  name="lead_id[]"  type="checkbox" value="<?php echo $transfer['id']; ?>"></td> 
						 <td><?php echo $transfer['id']; ?></td> 
						 <td><?php echo $transfer['dateadded']; ?></td> 
						
						 <td><?php echo $transfer['description']; ?></td>
						 <td><?php echo $transfer['opportunity']; ?></td>
						 <td>
						 ...
						 <div class="col-md-2 leads-filter-column">
							   <div class="_buttons">
								  ...
								  <input type="submit" value="<?php echo 'Transfer Leads'; ?>" class="btn mright5 btn-info pull-left display-block" class="checkbox mass_select_all_wrap">
								</div>    
                           </div>
					   <?php } ?>
                        </div>
