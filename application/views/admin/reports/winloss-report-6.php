						  ...
						  <?php
							 ...
							 */
								...
								if(in_array($res_rsm['staffid'], $chkrsm)){
									...
									$get_lost_amount_sum_rsm +=get_lost_amount_sum_rsm($res_rsm['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to'));
                                    
									$get_order_amount_sum_rsm += get_order_amount_sum_rsm($res_rsm['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to'));
						   ...
						   ?>
							...
							<tr style="text-align:center;background: #ff9201;">
								...
								<td><?php echo $get_order_amount_sum_rsm; ?></td>
								<td><?php echo $get_lost_amount_sum_rsm; ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
