               ...
               <div class="row">
					...
					<div class="col-md-2 leads-filter-column <?php if($this->input->post('from-region') !='pan_india'){ echo 'hidden'; } ?>" id="staff-div">
						  <h5>Staff:</h5>
						   ...
						   <?php }else{ 
							 ...
							 print_r( $this->input->post('region_id'));
							    
								if($this->input->post('region_id')){
								$region_ids = implode(',',$this->input->post('region_id'));
						 		$this->db->select()->from('tblstaff');
								$condt = "region IN(".$region_ids.") AND active = 1";
								$this->db->where($condt);
								$query = $this->db->get();
				  ...
				  <div class="col-md-12">
                     ...
                     <table class="table <?php if(($this->input->post('from-region')=='pan_india') || ($this->input->post('view_assigned') != '')){ echo 'hidden'; } ?>"  style="text-align:center;">
						...
						<tr>
							<th width="200px" style="text-align:center;" bgcolor="#f4b084" rowspan="2"><strong>Stages</strong></th>
							<th style="text-align:center;" bgcolor="#f4b084" colspan="3"><strong><?php echo date('M-Y', strtotime("-3 month")); ?></strong></th>
							<th style="text-align:center;" bgcolor="#f4b084" colspan="3"><strong><?php echo date('M-Y', strtotime("-2 month")) ;?></strong></th>
							<th style="text-align:center;" bgcolor="#f4b084" colspan="3"><strong><?php echo date('M-Y', strtotime("-1 month")) ;?></strong></th>
