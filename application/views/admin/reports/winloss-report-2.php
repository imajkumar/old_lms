						  ...
						  <?php
							 ...
							 */
								...
								if(in_array($res_zsm['staffid'], $chkzsm)){
									...
									$get_lost_amount_sum_zsm +=get_lost_amount_sum_zsm($res_zsm['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to'));
                                    
									$get_order_amount_sum_zsm += get_order_amount_sum_zsm($res_zsm['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to'));
						   ...
						   ?>
							...
							<tr style="text-align:center;background: #ff9201;">
								...
								<td><?php echo $get_order_amount_sum_zsm; ?></td>
								<td><?php echo $get_lost_amount_sum_zsm; ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
