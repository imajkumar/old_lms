						...
						<table class="collaptable table table-bordered">
						  ...
						  <?php
							 ...
							 */
								...
								$query_se = $this->db->query("SELECT staffid,emp_code,firstname,lastname FROM tblstaff where role=1 AND reporting_manager IN ('". $chkasm ."') ");
						   ...
						   ?>
							   <tr data-id="<?php echo $res_se['staffid']; ?>" data-parent="">
								...
								<td><?php echo get_opportunity_sum($res_se['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						   ...
						   ?>
							   <tr data-id="000" data-parent="<?php echo $res_se['staffid']; ?>">
								...
								<td><?php if($res4['status']==7)
										{ 
											echo $res4['opportunity']; 
										}else{
											echo '0'; 									
									} ?></td>
