						...
						<table class="collaptable table table-bordered">
						  ...
						  ?>
							<tr style="display: table-row;background: #d7b9f5; font-size: 14px;" data-id="<?php echo $res['staffid']; ?>" data-parent="">
								...
								<td><?php echo get_opportunity_sum($res['staffid'],$this->input->post('months-report')); ?></td>
								<td><?php echo get_project_total_amount_sum($res['staffid'],$this->input->post('months-report')); ?></td>
								<td><?php echo get_opportunity_sum_ASM_loss($res['staffid'],$this->input->post('months-report')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						   ...
						   ?>
							   <tr style="display: table-row;background: #99dde8; font-size: 14px;" data-id="<?php echo $res_rsm['staffid']; ?>" data-parent="<?php echo $chkdynsm_id; ?>">
								...
								<td><?php echo get_opportunity_sum($res_rsm['staffid'],$this->input->post('months-report')); ?></td>
								<td><?php echo get_project_total_amount_sum($res_rsm['staffid'],$this->input->post('months-report')); ?></td>
								<td><?php echo get_opportunity_sum_ASM_loss($res_rsm['staffid'],$this->input->post('months-report')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						   ...
						   ?>
							   <tr style="display: table-row;background: #ff9d9df5; font-size: 14px;" data-id="<?php echo $res_zsm['staffid']; ?>" data-parent="<?php echo $chkrsm_id; ?>">
								...
								<td><?php echo get_opportunity_sum($res_zsm['staffid'],$this->input->post('months-report')); ?></td>
								<td><?php echo get_project_total_amount_sum($res_zsm['staffid'],$this->input->post('months-report')); ?></td>
								<td><?php echo get_opportunity_sum_ASM_loss($res_zsm['staffid'],$this->input->post('months-report')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						   ...
						   ?>
							   <tr style="display: table-row;background: #fddede;font-size: 14px;" data-id="<?php echo $res_asm['staffid']; ?>" data-parent="<?php echo $chkzsm_id; ?>">
								...
								<td><?php echo get_opportunity_sum($res_asm['staffid'],$this->input->post('months-report')); ?></td>
								<td><?php echo get_project_total_amount_sum($res_asm['staffid'],$this->input->post('months-report')); ?></td>
								<td><?php echo get_opportunity_sum_ASM_loss($res_asm['staffid'],$this->input->post('months-report')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						   ...
						   ?>
							   <tr data-id="<?php echo $res_se['staffid']; ?>" data-parent="<?php echo $chkasm_id; ?>">
								...
								<td><?php echo get_project_total_amount_sum_s($res_se['staffid'],$this->input->post('months-report')); ?></td>
								<td><?php echo get_opportunity_sum_Sales_loss($res_se['staffid'],$this->input->post('months-report')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
