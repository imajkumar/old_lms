				   ...
				   ?>
					   <tr data-id="<?php echo $totrsm; ?>" data-parent="<?php echo $total_chkrsm; ?>">
						...
						<?php
							...
							$total_chkzsm=$totrsm;
							$totzsm = $total_chkzsm + 1;
							foreach($result2 as $res2){
							if(in_array($res2['staffid'], $chkzsm)){
					   ?>
						   <tr data-id="<?php echo $totzsm; ?>" data-parent="<?php echo $total_chkzsm; ?>">
							...
							<?php
								...
								if(in_array($res3['staffid'], $chkasm)){
						   ?>
							   <tr data-id="<?php echo $totasm; ?>" data-parent="<?php echo $total_chkasm; ?>">
								...
								<td><?php echo get_opportunity_sum($res3['staffid']); ?></td>
								<td><?php echo get_project_total_amount_sum($res3['staffid']); ?></td>
								<td><?php echo get_opportunity_sum($res3['staffid']); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								...
								<?php
									$query4 = $this->db->query('SELECT staffid,emp_code,firstname,lastname FROM tblstaff where reporting_manager IN ("'.$res2['staffid'].'")');
								
									$result4 = $query4->result_array();
									$total_chkse=$totasm;
									$totse = $total_chkse + 100;
									foreach($result4 as $res4){
									if(in_array($res4['staffid'], $chkse)){
							   ?>
								   <tr data-id="<?php echo $totse; ?>" data-parent="<?php echo $totasm; ?>">
									<td style="text-align: left !important;"><?php echo $res4['firstname'].' '.$res4['lastname']; ?></td>
									<td><?php echo get_opportunity_sum_s($res4['staffid']); ?></td>
									<td><?php echo get_project_total_amount_sum_s($res4['staffid']); ?></td>
									<td><?php echo get_opportunity_sum_s($res4['staffid']); ?></td>
									<td>-</td>
									<td>-</td>
									<td>-</td>
									...
									<td>-</td>
									  ...
									  <?php
										$query5 = $this->db->query('SELECT * FROM tblleads where assigned = "'.$res4['staffid'].'"');
								   ...
								   ?>
									   <tr data-id="<?php echo $totse; ?>" data-parent="<?php echo $total_chkse; ?>">
										...
										<td><?php echo $res5['opportunity']; ?></td>
										<td><?php if(isset($res5['project_total_amount'])){ echo $res5['project_total_amount']; }else{ echo '0';}; ?></td>
										<td><?php if($res5['status']==7){ echo $res5['opportunity']; }else{ echo '0'; } ?></td>
										<td><?php echo $res5['region']; ?></td>
										<td><?php echo $this->leads_model->get_city_name($res5['city']); ?></td>
										<td><?php echo $this->leads_model->get_emp_name($res5['assigned']); ?></td>
										<td><?php echo $res5['customer_type']; ?></td>
										<td><?php echo $this->leads_model->get_customer_name($res5['customer_name']); ?></td>
										<td><?php 
											
												$CAT = $this->leads_model->get_product_description($res5['id']);
												$string = '';
										...
										<td><?php echo $this->leads_model->get_status_name($res5['status']); ?></td>
										<td><?php echo $res5['project_awarded_to']; ?></td>
									  </tr>
									  <?php
