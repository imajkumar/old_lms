...
//-------------------- ASM -------------------------------//
 ...
 function get_opportunity_sum($staff_id='',$filter=''){
	$ci =& get_instance();
	if($filter=='this_month'){
		$month = date('Y-m');
 ...
 function get_project_total_amount_sum($staff_id='',$filter=''){
	$ci =& get_instance();
 ...
 function get_opportunity_sum_s($staff_id='',$filter=''){
	$ci =& get_instance();
	if($filter=='this_month'){
		$month = date('Y-m');
 ...
 function get_project_total_amount_sum_s($staff_id='',$filter=''){
	$ci =& get_instance();
						...
						<table class="collaptable table table-bordered">
						  ...
						  ?>
							<tr style="display: table-row;background: #d7b9f5; font-size: 14px;" data-id="<?php echo $res_dynsm['staffid']; ?>" data-parent="">
								...
								<td><?php echo get_opportunity_sum_dynsm($res_dynsm['staffid'],$this->input->post('months-report')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						   ...
						   ?>
							   <tr style="display: table-row;background: #99dde8; font-size: 14px;" data-id="<?php echo $res_rsm['staffid']; ?>" data-parent="<?php echo $chkdynsm_id; ?>">
								...
								<td><?php echo get_opportunity_sum_rsm($res_rsm['staffid'],$this->input->post('months-report')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						   ...
						   ?>
							   <tr style="display: table-row;background: #ff9d9df5; font-size: 14px;" data-id="<?php echo $res_zsm['staffid']; ?>" data-parent="<?php echo $chkrsm_id; ?>">
								...
								<td><?php echo get_opportunity_sum_zsm($res_zsm['staffid'],$this->input->post('months-report')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
							...
							<?php
								...
								if($filter=='this_month'){
									...
									$query4 = $this->db->query('SELECT * FROM tblleads where assigned = "'.$res_zsm['staffid'].'" AND (dateadded BETWEEN "'.$report_from.' 00:00:00" AND "'.$report_to.' 23:59:59" )  AND status NOT IN(6,7)');
								}else{
						   ...
						   ?>
							   <tr style="display: table-row;background: #fddede;font-size: 14px;" data-id="<?php echo $res_asm['staffid']; ?>" data-parent="<?php echo $chkzsm_id; ?>">
								...
								<td><?php echo get_opportunity_sum_asm($res_asm['staffid'],$this->input->post('months-report')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						   ...
						   ?>
							   <tr data-id="<?php echo $res_se['staffid']; ?>" data-parent="<?php echo $chkasm_id; ?>">
								...
								<td><?php echo get_opportunity_sum_Sales($res_se['staffid'],$this->input->post('months-report')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
