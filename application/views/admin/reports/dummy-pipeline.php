						  ...
						  ?>
						   ...
						   ?>
							   <tr data-id="<?php echo $totrsm; ?>" data-parent="<?php echo $total_chkrsm; ?>">
								<td style="text-align: left !important;"><?php echo $res_rsm['firstname'].' '.$res_rsm['lastname']; ?></td>
								<td><?php echo get_opportunity_sum($res_rsm['staffid']); ?></td>
								<td><?php echo get_project_total_amount_sum($res_rsm['staffid']); ?></td>
								<td><?php echo get_opportunity_sum($res_rsm['staffid']); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						   ...
						   ?>
							   <tr data-id="<?php echo $totzsm; ?>" data-parent="<?php echo $total_chkzsm; ?>">
								<td style="text-align: left !important;"><?php echo $res_zsm['firstname'].' '.$res_zsm['lastname']; ?></td>
								<td><?php echo get_opportunity_sum($res_zsm['staffid']); ?></td>
								<td><?php echo get_project_total_amount_sum($res_zsm['staffid']); ?></td>
								<td><?php echo get_opportunity_sum($res_zsm['staffid']); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
							...
							<?php
								...
								$query_asm = $this->db->query('SELECT staffid,emp_code,firstname,lastname FROM tblstaff where role=3 AND reporting_manager IN ('.$chkzsm_id.')');
						   ...
						   ?>
							   <tr data-id="<?php echo $totasm; ?>" data-parent="<?php echo $total_chkasm; ?>">
								<td style="text-align: left !important;"><?php echo $res_asm['firstname'].' '.$res_asm['lastname']; ?></td>
								<td><?php echo get_opportunity_sum($res_asm['staffid']); ?></td>
								<td><?php echo get_project_total_amount_sum($res_asm['staffid']); ?></td>
								<td><?php echo get_opportunity_sum($res_asm['staffid']); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
							...
							<?php
								...
								$query_se = $this->db->query('SELECT staffid,emp_code,firstname,lastname FROM tblstaff where role=1 AND reporting_manager IN ('.$chkasm_id.')');
						   ...
						   ?>
							   <tr data-id="<?php echo $totse; ?>" data-parent="<?php echo $total_chkse; ?>">
								<td style="text-align: left !important;"><?php echo $res_se['firstname'].' '.$res_se['lastname']; ?></td>
								<td><?php echo get_opportunity_sum_s($res_se['staffid']); ?></td>
								<td><?php echo get_project_total_amount_sum_s($res_se['staffid']); ?></td>
								<td><?php echo get_opportunity_sum_s($res_se['staffid']); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
