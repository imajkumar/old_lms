...
//-------------------- Own -------------------------------//
 ...
 function get_lost_amount_sum_own($staff_id='',$filter='',$report_from='',$report_to=''){
	$ci =& get_instance();
 ...
 function get_order_amount_sum_own($staff_id='',$filter='',$report_from='',$report_to=''){
	$ci =& get_instance();
...
//-------------------- Sales Executive ---------------------//
 ...
 function get_lost_amount_sum_se($staff_id='',$filter='',$report_from='',$report_to=''){
	$ci =& get_instance();
	if($filter=='this_month'){
		$month = date('Y-m');
		$query = $ci->db->query('SELECT COALESCE(SUM(opportunity),0) as total_opportunity FROM tblleads where assigned LIKE ("%'.$staff_id.'%") AND dateadded LIKE ("'.$month.'%") AND status=7');
 ...
 function get_order_amount_sum_se($staff_id='',$filter='',$report_from='',$report_to=''){
	$ci =& get_instance();
					...
					<div class="row">
						  ...
						  <?php
							 ...
							 */
								...
								foreach($result_asm as $res_asm){
									...
									$get_order_amount_sum_own += get_order_amount_sum_own($res_asm['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to'));
					 
									$get_lost_amount_sum_own += get_lost_amount_sum_own($res_asm['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to'));
						   ?>
							   <tr style="display: table-row;background: #fddede;font-size: 14px;" data-id="<?php echo $res_asm['staffid']; ?>" data-parent="">
								...
								<td><?php echo get_order_amount_sum_own($res_asm['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to')); ?></td>
								<td><?php echo get_lost_amount_sum_own($res_asm['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						...
						<?php
						   ...
						   ?>
							   <tr data-id="<?php echo $res_asm['staffid']+500; ?>" data-parent="<?php echo $res_asm['staffid']; ?>">
								...
								<td><?php if($res4res_asm['status']==7)
										{ 
											echo $res4res_asm['opportunity']; 
										}else{
											echo '0'; 									
									} ?></td>
						...
						<?php	 
								...
								foreach($result_se as $res_se){
									...
									$get_order_amount_sum_se += get_order_amount_sum_se($res_se['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to'));
					 
									$get_lost_amount_sum_se += get_lost_amount_sum_se($res_se['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to'));
						   ...
						   ?>
							   <tr data-id="<?php echo $res_se['staffid']; ?>" data-parent="<?php echo $res_asm['staffid']; ?>">
								...
								<td><?php echo get_order_amount_sum_se($res_se['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to')); ?></td>
								<td><?php echo get_lost_amount_sum_se($res_se['staffid'],$this->input->post('months-report'),$this->input->post('report-from'),$this->input->post('report-to')); ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
						...
						?>
							<tr style="text-align:center;background: #ff9201;">
								...
								<td><?php echo $get_order_amount_sum_own; ?></td>
								<td><?php echo $get_lost_amount_sum_own; ?></td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
