...
<div id="wrapper" style="min-height: 1385px;">
   ...
   <div class="panel-body">
      ...
      <div class="row">
         <div class="col-md-6">
             ...
             <div class="form-group select-placeholder">
               ...
               <?php 
			    foreach($Leads as $leads){ ?>
                  <option value="<?php echo $leads['id']; ?>"><?php echo $leads['company']; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="clearfix mbot15 hidden"></div>
   ...
   <?php $this->load->view('admin/lead_requirment/_add_edit_items'); ?>
   <div class="row">
      <div class="col-md-12 mtop15">
         <div class="panel-body bottom-transaction">
            ...
            <div class="btn-bottom-toolbar text-right" style=" margin: -1px 0 0 -17px;">
