...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="contact-profile-image" class="form-group<?php if(isset($contact) && !empty($contact->profile_image)){echo ' hide';} ?>">
                            <label for="profile_image" class="profile-image"><?php echo _l('Visiting Card'); ?></label>
                       ...
                       <?php echo  render_input( 'title', 'contact_position',$value); ?>
                        ...
                        <?php $value=( isset($contact) ? $contact->mobilenumber : ''); ?>
                        <?php echo render_input( 'mobilenumber', 'Mobile No.',$value,'text',array('autocomplete'=>'off')); ?>
                    ...
                    <div class="client_password_set_wrapper hide">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" value="sdfsdfsdfsf" class="form-control password" name="password" autocomplete="false">
    ...
    <div class="modal-footer">
		...
		<?php
			if(get_staff_role() > 1 || $contact->firstname == '' ) 
			{
		?>
