<div class="modal fade" id="status" tabindex="-1" role="dialog">
   <div class="modal-dialog">
      <?php echo form_open(admin_url('leads/loass_status_add'), array('id'=>'leads-status-form')); ?>
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">
               <span class="edit-title"><?php echo 'Edit Status'; ?></span>
               <span class="add-title"><?php echo 'Add Loss Status'; ?></span>
            </h4>
         </div>
         <div class="modal-body">
            <div class="row">
               <div class="col-md-12">
                  ...
                  <?php echo render_input('name', 'Status'); ?>
                  <label class="control-label" for="lead-lead_status_id">Lead Status</label>
				   <select id="lead-lead_status_id" required class="form-control" name="status_id">
...
function edit_status(invoker, id) {
    ...
    $('#status input[name="status_id"]').val($(invoker).data('status_id'));
    $('#status').modal('show');
