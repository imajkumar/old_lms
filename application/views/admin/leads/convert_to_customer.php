      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <?php if(mb_strpos($lead->name,' ') !== false){
               $_temp = explode(' ',$lead->customer_name);
               $firstname = $_temp[0];
               if(isset($_temp[2])){
           ...
           <?php echo render_input('firstname','Customer Name',$firstname); ?>
           <?php echo form_hidden('lastname','lead_convert_to_client_lastname',$lastname); ?>
           <?php echo form_hidden('title','contact_position',$lead->title); ?>
           ...
           <?php echo render_input('phonenumber','lead_convert_to_client_phone',$lead->phonenumber); ?>
			...
			<label for="zip" class="control-label">Valid From</label>
			<input type="date" id="valid_from" name="valid_from" class="form-control">
		</div>
		<div class="form-group" app-field-wrapper="zip">
			<label for="zip" class="control-label">Valid To</label>
           ...
           <?php echo form_hidden('country','client_country',$lead->country); ?>
