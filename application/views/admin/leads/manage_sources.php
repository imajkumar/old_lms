                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<?php											
												if($source['status'] == 1){
											?>
												<a href="<?php echo admin_url('leads/source_status_inactive/'.$source['id']); ?>" class="btn btn-danger"><i class="fa fa-ban"></i></a>
											<?php }else{ ?>
												<a href="<?php echo admin_url('leads/source_status_active/'.$source['id']); ?>" class="btn btn-danger"><i class="fa fa-check"></i></a>
