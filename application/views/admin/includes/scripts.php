...
<script src="<?php echo base_url('assets/jquery.aCollapTable.js'); ?>"></script>
<script>
$(document).ready(function(){
  $('.collaptable').aCollapTable({ 
    startCollapsed: true,
    addColumn: false, 
    plusButton: '<span class="i"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;</span>', 
    minusButton: '<span class="i"><i class="fa fa-minus" aria-hidden="true"></i>&nbsp;</span>' 
  });
});
</script>
