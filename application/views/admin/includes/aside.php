...
<aside id="menu" class="sidebar">
   <ul class="nav metis-menu" id="side-menu">
      ...
      <li  title="<?php echo _l($item->name); ?>">
      ...
      <li title="<?php echo _l('setting_bar_heading'); ?>" class="<?php if(get_option('show_setup_menu_item_only_on_hover') == 1) { echo ' style="display:none;"'; } ?>" id="setup-menu-item">
