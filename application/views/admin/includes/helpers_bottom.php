...
<!-- Task modal view -->
<div class="modal fade task-modal-single" id="task-modal"  role="dialog" aria-labelledby="myLargeModalLabel">
...
<!-- Lead Data Add/Edit-->
<div class="modal fade lead-modal" id="lead-modal" role="dialog" aria-labelledby="myLargeModalLabel">
