...
class Knowledge_base_model extends CRM_Model
{
    ...
    {
        $this->db->select('slug,articleid, articlegroup, subject,tblknowledgebase.description,tblknowledgebase.image,tblknowledgebase.active as active_article,tblknowledgebasegroups.active as active_group,name as group_name,staff_article,datecreated');
     ...
     */
    public function add_article_data($data)
    {
...
$this->db->insert('tblknowledgebase', $data);
 ...
 public function edit_knowledge_base($data, $id)
    {
        $this->db->where('articleid', $id);
        $this->db->update('tblknowledgebase', $data);
	 ...
	 public function update_kan_ban($id = null) {
        $this->db->select()->from('tblknowledgebase');
