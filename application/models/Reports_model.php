...
class Reports_model extends CRM_Model
{
	...
	public function get_categories($id){
        ...
        $this->db->select('staffid,emp_code,firstname,lastname,reporting_manager,role');
        $this->db->from('tblstaff');
        $this->db->where('reporting_manager', $id);
        ...
        foreach($categories as $p_cat){
            ...
            $categories[$i]->sub = $this->sub_categories($p_cat->staffid);
            $i++;
        }
        return $categories;
    }
