...
class Estimates_model extends CRM_Model
{
    ...
    public function get_attachments($estimate_id, $id = '')
    {
	 ...
	 public function list_requirment_data($id = null) {
        $this->db->select()->from('tbllead_requirment');
        if ($id != null) {
            $this->db->where('id', $id);
        } else {
            $this->db->order_by('i');
	...
	public function list_requirment_detail($id = null) {
	...
	public function company_detail($id = null) {
        $this->db->select('tblleads');
		 $this->db->join('tblstaff', 'tblstaff.staffid = tblleads.id');
    ...
    {
		 $this->db->select('tbllead_requirment.*,tblstaff.firstname as full_name,tblleads.company as company');
         $this->db->join('tblstaff', 'tblstaff.staffid = tbllead_requirment.added_by');
         $this->db->join('tblleads', 'tblleads.id = tbllead_requirment.lead_id');
        $result = $this->db->get('tbllead_requirment');
        if (is_numeric($id)) {
            return $result->row();
        } else {
            return $result->result_array();
	...
	public function requirement_data_list($id) {
        $this->db->select('tbllead_requirment.*,tblstaff.firstname,tblleads.company,');
        ...
        $query = $this->db->get('tbllead_requirment');
        
            return $query->result_array();
        
    }
	
	public function requirement_data_lead($id)
    {
		 $this->db->select('tbllead_requirment_detail.*,tblitems_groups.name,tblitems.description,');
         $this->db->join('tblitems_groups', 'tblitems_groups.id = tbllead_requirment_detail.category_id'); 
		 $this->db->join('tblitems', 'tblitems.id = tbllead_requirment_detail.item_id');
       $this->db->where('lead_requirment_id', $id);
        $result = $this->db->get('tbllead_requirment_detail');
