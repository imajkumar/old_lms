$(document).ready(function(){
  $("#wrapper").css("margin", "0 0 0 45px");
  $("#setup-menu").addClass("fadeInLeft");
  $("#menu").mouseover(function(){
    $("#wrapper").css("margin", "0 0 0 210px");
  });
...
function _init_tasks_billable_select(e, t) {
	...
	if (a.length > 0) {
		...
		a.find("option").filter(function () {
			...
			i = " ", 1 == t.started_timers ? i += 'disabled class="text-danger important" data-subtext="' + appLang.invoice_task_billable_timers_found + '"' : 0 == t.started_timers && "project" != t.rel_type && (i += 'data-subtext="' + t.rel_name + '"'), a.append('<option value="' + t.id + '"' + i + ">" + t.name + "</option>")
		});
...
function switch_field(e) {
	var t;
	t = 0, 1 == $(e).prop("checked") && (t = 1), requestGet($(e).data("switch-url") + "/" + $(e).data("id") + "/" + t)
}
...
function delete_option(e, t) {
	confirm_delete() && requestGetJSON("settings/delete_option/" + t).done(function (t) {
		1 == t.success && $(e).parents(".option").remove()
	})
}
...
function init_rel_tasks_table(e, t, a) {
	...
	if (0 != i.length) {
		var n, s, o = {};
		s = $("._hidden_inputs._filters._tasks_filters input"), $.each(s, function () {
			o[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
		});
		var l = admin_url + "tasks/init_relation_tasks/" + e + "/" + t;
		n = [i.find("th").length - 1], "project" == i.attr("data-new-rel-type") && (n.push(0), l += "?bulk_actions=true");
		var d = initDataTable(i, l, n, n, o, [i.find("th.duedate").index(), "ASC"]);
		d && "lead" == t && d.column($("table .table-tasks-options").index()).visible(!1, !1).columns.adjust()
	}
}

function get_dt_export_buttons(e) {
	...
	var n = {
			body: function (e, t, a, i) {
				var n = $("<div></div>", e);
				n.append(e), n.find("[data-note-edit-textarea]").length > 0 && (n.find("[data-note-edit-textarea]").remove(), e = n.html().trim());
	...
	0 == app_show_table_columns_visibility && delete s[1], table_export_button_is_hidden() && delete s[0];
	...
	if (0 != a.length) {
		...
		if (app_tables_pagination_limit = parseFloat(app_tables_pagination_limit), -1 == $.inArray(app_tables_pagination_limit, i) && (i.push(app_tables_pagination_limit), n.push(app_tables_pagination_limit)), i.sort(function (e, t) {
			...
			var s, o, l = {
				...
				d = $($(this)).attr("data-order-col"),
				r = $($(this)).attr("data-order-type");
			$.each(a, function () {
				$(this).addClass("dt-no-serverside"), s = l, ($(this).hasClass("scroll-responsive") || 1 == app_scroll_responsive_tables) && (s.responsive = !1), d = $(this).attr("data-order-col"), r = $(this).attr("data-order-type"), d && r && (s.order = [
					[d, r]
				]), delete(o = get_dt_export_buttons(this))[2], s.buttons = o;
				var e = $(this).DataTable(s);
...
function initDataTable(e, t, a, i, n, s) {
	...
	var l = [10, 25, 50, 100],
		d = [10, 25, 50, 100];
	app_tables_pagination_limit = parseFloat(app_tables_pagination_limit), -1 == $.inArray(app_tables_pagination_limit, l) && (l.push(app_tables_pagination_limit), d.push(app_tables_pagination_limit)), l.sort(function (e, t) {
		return e - t
	}), d.sort(function (e, t) {
		return e - t
	}), l.push(-1), d.push(appLang.dt_length_menu_all);
	var r = {
		language: appLang.datatables,
		processing: !0,
		retrieve: !0,
		...
		initComplete: function (e, t) {
			var a = this;
			$(".btn-dt-reload").attr("data-toggle", "tooltip"), $(".btn-dt-reload").attr("title", appLang.dt_button_reload), (a.hasClass("scroll-responsive") || 1 == app_scroll_responsive_tables) && a.wrap('<div class="table-responsive"></div>');
			var i = a.find(".dataTables_empty");
			i.length && i.attr("colspan", a.find("thead th").length), is_mobile() && $(window).width() < 400 && a.find('tbody td:first-child input[type="checkbox"]').length > 0 && (a.DataTable().column(0).visible(!1, !1).columns.adjust(), $("a[data-target*='bulk_actions']").addClass("hide")), a.parents(".table-loading").removeClass("table-loading"), a.removeClass("dt-table-loading");
			var n = a.find("thead th:last-child"),
				s = a.find("thead th:first-child");
			n.text().trim() == appLang.options && n.addClass("not-export"), s.find('input[type="checkbox"]').length > 0 && s.addClass("not-export"), mainWrapperHeightFix()
		},
		order: s,
		ajax: {
			url: t,
			...
			error: function (e) {
				"" != e.responseText && alert_float("danger", e.responseText)
			}
		},
		buttons: get_dt_export_buttons(o)
	};
	(o.hasClass("scroll-responsive") || 1 == app_scroll_responsive_tables) && (r.responsive = !1);
	var c = (o = o.dataTable(r)).DataTable(),
		_ = o.find("th.not_visible"),
		p = [];
	return $.each(_, function () {
		p.push(this.cellIndex)
	}), setTimeout(function () {
		for (var e in p) c.columns(p[e]).visible(!1, !1).columns.adjust()
	}, 10), o.is(":hidden") && o.find(".dataTables_empty").attr("colspan", o.find("thead th").length), $(document).on("change", ".dt-page-jump-select", function () {
		c.page($(this).val() - 1).draw(!1)
	}), c
}
...
function delete_todo_item(e, t) {
	requestGetJSON("todo/delete_todo_item/" + t).done(function (t) {
		1 == t.success && ($(e).parents("li").remove(), update_todo_items())
	})
}
...
function init_datepicker(e, t) {
	var a = void 0 === e ? $(".datepicker") : e,
		i = void 0 === t ? $(".datetimepicker") : t;
	if (0 != i.length || 0 != a.length) {
		$.each(a, function () {
			var e = {
				...
				t = $(this).data("date-end-date"),
				a = $(this).data("date-min-date");
			t && (e.maxDate = t), a && (e.minDate = a), $(this).datetimepicker(e)
		});
		var n;
		$.each(i, function () {
			n = {
				...
				validateOnBlur: !1,
				dayOfWeekStart: app_calendar_first_day
			}, 24 == app_time_format ? n.format = app_date_format + " H:i" : (n.format = app_date_format + " g:i A", n.formatTime = "g:i A");
			var e = $(this).data("date-end-date"),
				t = $(this).data("date-min-date");
			e && (n.maxDate = e), t && (n.minDate = t), $(this).datetimepicker(n)
		})
	}
}
...
function do_filter_active(e, t) {
	if ("" != e && void 0 !== e) {
		...
		if (i.hasClass("filter-group")) {
			...
			$('[data-filter-group="' + n + '"]').not(i).removeClass("active"), $('input[name="' + e + '"]').val("")
		}
...
function toggle_small_view(e, t) {
	...
	if (0 != a.length) {
		...
		var n = $(e).DataTable();
		n.columns(hidden_columns).visible(i, !1), n.columns.adjust(), $(t).toggleClass("hide")
	}
}
...
function reminderFormHandler(e) {
	...
	}), $("body").hasClass("all_reminders") ? $(".reminder-modal--").modal("hide") : $(".reminder-modal-" + e.find('[name="rel_type"]').val() + "-" + e.find('[name="rel_id"]').val()).modal("hide"), !1
}
...
function edit_note(e) {
	...
	"" != t && ($.post(admin_url + "misc/edit_note/" + e, {
		...
		1 == (a = JSON.parse(a)).success && (alert_float("success", a.message), $("body").find('[data-note-description="' + e + '"]').html(nl2br(t)))
	}), toggle_edit_note(e))
}
...
function kanban_load_more(e, t, a, i, n) {
	...
	if (d <= r) {
		var c = $('input[name="sort_type"]'),
			_ = $('input[name="sort"]').val();
		0 != c.length && "" != c.val() && (o.sort_by = c.val(), o.sort = _), void 0 !== l && "" != l && (o.search = l), $.each($("#kanban-params input"), function () {
...
function init_kanban(e, t, a, i, n, s) {
	if (0 != $("#kan-ban").length) {
		...
		0 != r.length && "" != r.val() && (l.sort_by = r.val(), l.sort = c), l.kanban = !0;
		var e = admin_url + e;
		e = buildUrl(e, l), delay(function () {
...
function like_post(e) {
	requestGetJSON("newsfeed/like_post/" + e).done(function (t) {
		1 == t.success && refresh_post_likes(e)
	})
}
...
function like_comment(e, t) {
	requestGetJSON("newsfeed/like_comment/" + e + "/" + t).done(function (t) {
		1 == t.success && $('[data-commentid="' + e + '"]').replaceWith(t.comment)
	})
}
...
function add_comment(e) {
	...
	$.post(admin_url + "newsfeed/add_comment", {
		...
		1 == (a = JSON.parse(a)).success && ($(e).val(""), $("body").find('[data-comments-postid="' + t + '"] .post-comment').length > 0 ? $("body").find('[data-comments-postid="' + t + '"] .post-comment').prepend(a.comment) : refresh_post_comments(t))
	})
}

function remove_post_comment(e, t) {
	requestGetJSON("newsfeed/remove_post_comment/" + e + "/" + t).done(function (t) {
		1 == t.success && $('.comment[data-commentid="' + e + '"]').remove()
	})
}
...
function delete_post(e) {
	confirm_delete() && $.post(admin_url + "newsfeed/delete_post/" + e, function (t) {
		1 == t.success && $('[data-main-postid="' + e + '"]').remove()
	}, "json")
}

function pin_post(e) {
	requestGetJSON("newsfeed/pin_newsfeed_post/" + e).done(function (e) {
		1 == e.success && window.location.reload()
	})
}
...
function init_lead(e) {
	$("#task-modal").is(":visible") && $("#task-modal").modal("hide"), init_lead_modal_data(e) && $("#lead-modal").modal("show")
}
...
function validate_lead_convert_to_client_form() {
	var e = {
		...
		password: {
			required: {
				depends: function (e) {
					if (0 == $('input[name="send_set_password_email"]').prop("checked")) return !0
				}
			}
		},
		email: {
...
function lead_profile_form_handler(e) {
	var t = (e = $(e)).serialize();
	$(e).serializeArray(), $("#lead-modal").find('input[name="leadid"]').val();
...
function _lead_init_data(e, t) {
	...
	if ($("#lead_reminder_modal").html(e.leadView.reminder_data), i.find(".data").html(e.leadView.data), i.modal({
			show: !0,
			backdrop: "static"
		}), init_tags_inputs(), init_selectpicker(), init_form_reminder(), init_datepicker(), init_color_pickers(), validate_lead_form(), "#tab_lead_profile" != a && "#attachments" != a && "#lead_notes" != a || (window.location.hash = a), "" != t && void 0 !== t) {
...
function init_lead_modal_data(e, t) {
	requestGetJSON((void 0 !== t ? t : "leads/lead/") + (void 0 !== e ? e : "")).done(function (t) {
		_lead_init_data(t, e)
	}).fail(function (e) {
		alert_float("danger", e.responseText)
	})
...
function leads_kanban_update(e, t) {
	if (t === e.item.parent()[0]) {
		...
		$.each(n, function () {
			...
			$.post(admin_url + "leads/update_kan_ban_lead_status", a).done(function (e) {
...
function delete_lead_attachment(e, t) {
	confirm_delete() && requestGetJSON("leads/delete_attachment/" + t).done(function (t) {
		1 == t.success && $(e).parents(".lead-attachment-wrapper").remove()
	}).fail(function (e) {
		alert_float("danger", e.responseText)
	})
}

function delete_lead_note(e, t) {
	confirm_delete() && requestGetJSON("leads/delete_note/" + t).done(function (t) {
		1 == t.success && $(e).parents(".lead-note").remove()
	}).fail(function (e) {
		alert_float("danger", e.responseText)
	})
}
...
function lead_mark_as_lost(e) {
	requestGetJSON("leads/mark_as_lost/" + e).done(function (t) {
		1 == t.success && (alert_float("success", t.message), $("body").find("tr#lead_" + e).remove(), $("body").find('#kan-ban li[data-lead-id="' + e + '"]').remove()), _lead_init_data(t, t.id)
	}).fail(function (e) {
		alert_float("danger", e.responseText)
	})
}
...
function lead_unmark_as_lost(e) {
	requestGetJSON("leads/unmark_as_lost/" + e).done(function (e) {
		1 == e.success && alert_float("success", e.message), _lead_init_data(e, e.id)
	}).fail(function (e) {
		alert_float("danger", e.responseText)
	})
}
...
function leads_bulk_action(e) {
	if (confirm_delete()) {
		var t = $("#mass_delete").prop("checked"),
			...
			i = {};
		if (0 == t || void 0 === t) {
			if (i.status = $("#move_to_status_leads_bulk").val(), i.assigned = $("#assign_to_leads_bulk").val(), i.source = $("#move_to_source_leads_bulk").val(), i.last_contact = $("#leads_bulk_last_contact").val(), i.tags = $("#tags_bulk").tagit("assignedTags"), i.visibility = $('input[name="leads_bulk_visibility"]:checked').val(), i.assigned = void 0 === i.assigned ? "" : i.assigned, i.visibility = void 0 === i.visibility ? "" : i.visibility, "" == i.status && "" == i.assigned && "" == i.source && "" == i.last_contact && "" == i.tags && "" == i.visibility) return
...
function init_table_tickets(e) {
	...
	if (0 != $("body").find(".tickets-table").length) {
		var t = $(".tickets-table").find("th").length - 1,
			a = {},
			i = $("._hidden_inputs._filters.tickets_filters input"),
			n = $("table.tickets-table thead .ticket_created_column").index();
		$.each(i, function () {
			a[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
		}), a.project_id = '[name="project_id"]';
		var s = [t],
			o = admin_url + "tickets";
		$("body").hasClass("tickets_page") && (s.push(0), o += "?bulk_actions=true"), _table_api = initDataTable(".tickets-table", o, s, s, a, [n, "DESC"]), _table_api && $("body").hasClass("dashboard") && _table_api.column(t).visible(!1, !1).column(3).visible(!1, !1).column(n).visible(!1, !1).column(4).visible(!1, !1).column(5).visible(!1, !1).columns.adjust()
	}
}
...
function init_table_staff_leads(e) {
	
	if (0 != $("body").find(".table-staffleads").length) {
		var t = {},
			a = $("._hidden_inputs._filters.staff_leads_filter input");
		$.each(a, function () {
			t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
		}), initDataTable(".table-staffleads", admin_url + "leads/staff_leads", "undefined", "undefined", t, [2, "ASC"])
	}
}
...
function delete_checklist_item(e, t) {
	requestGetJSON("tasks/delete_checklist_item/" + e).done(function (e) {
		1 == e.success && ($(t).parents(".checklist").remove(), recalculate_checklist_items_progress())
	})
}
...
function remove_task_attachment(e, t) {
	confirm_delete() && requestGetJSON("tasks/remove_task_attachment/" + t).done(function (e) {
		1 == e.success && $('[data-task-attachment-id="' + t + '"]').remove();
		var a = $("body").find(".task_attachments_wrapper"),
			i = a.find(".task-attachment-col"),
			n = $("body").find("#show-more-less-task-attachments-col .task-attachments-more");
		0 == i.length ? a.remove() : 2 == i.length && n.hasClass("hide") ? $("body").find("#show-more-less-task-attachments-col").remove() : 0 != $(".task-attachment-col:visible").length || n.hasClass("hide") || n.click()
	})
}

function add_task_comment(e) {
	var t = {};
	t.content = tinyMCE.activeEditor.getContent(), t.taskid = e, $.post(admin_url + "tasks/add_task_comment", t).done(function (e) {
...
function remove_assignee(e, t) {
	confirm_delete() && requestGetJSON("tasks/remove_assignee/" + e + "/" + t).done(function (e) {
		1 == e.success && (alert_float("success", e.message), _task_append_html(e.taskHtml))
	})
}
...
function task_mark_as(e, t, a) {
	...
	a += "?single_task=" + i, $("body").append('<div class="dt-loader"></div>'), requestGetJSON(a).done(function (a) {
		$("body").find(".dt-loader").remove(), 1 == a.success && (reload_tasks_tables(), i && _task_append_html(a.taskHtml), 5 == e && "function" == typeof _maybe_remove_task_from_project_milestone && _maybe_remove_task_from_project_milestone(t), 0 == $(".tasks-kanban").length && alert_float("success", a.message))
	})
}
...
function task_change_priority(e, t) {
	...
	url += "?single_task=" + a, requestGetJSON(url).done(function (e) {
		1 == e.success && (reload_tasks_tables(), a && _task_append_html(e.taskHtml))
	})
}
...
function make_task_public(e) {
	requestGetJSON("tasks/make_public/" + e).done(function (e) {
		1 == e.success && (reload_tasks_tables(), _task_append_html(e.taskHtml))
	})
}
...
function task_form_handler(e) {
	tinymce.triggerSave(), $("#_task_modal").find('input[name="startdate"]').prop("disabled", !1);
	var t = e.action,
		a = new FormData($(e)[0]);
	return $.ajax({
		type: $(e).attr("method"),
		...
		if (1 == (e = JSON.parse(e)).success && alert_float("success", e.message), $("body").hasClass("project")) {
...
function _task_append_html(e) {
	$("#task-modal .data").html(e), recalculate_checklist_items_progress(), do_task_checklist_items_height(), setTimeout(function () {
		$("#task-modal").modal("show"), $("#task-modal").is(":visible") && init_tags_inputs(), fix_task_modal_left_col_height()
	}, 150)
}
...
function edit_task_comment(e) {
	...
	t.next().addClass("hide"), t.removeClass("hide"), tinymce.remove("#task_comment_" + e), init_editor("#task_comment_" + e, _simple_editor_config()), tinymce.triggerSave()
}
...
function _simple_editor_config() {
	return {
		...
		auto_focus: !0,
		menubar: !1,
		plugins: ["table advlist codesample autosave autoresize lists link image textcolor media contextmenu paste"],
...
function save_edited_comment(e, t) {
	tinymce.triggerSave();
	var a = {};
	a.id = e, a.task_id = t, a.content = $('[data-edit-comment="' + e + '"]').find("textarea").val(), $.post(admin_url + "tasks/edit_comment", a).done(function (t) {
		1 == (t = JSON.parse(t)).success ? (alert_float("success", t.message), _task_append_html(t.taskHtml)) : cancel_edit_comment(e), tinymce.remove('[data-edit-comment="' + e + '"] textarea')
	})
}
...
function clear_billing_and_shipping_details() {
	for (var e in bs_fields) bs_fields[e].indexOf("country") > -1 ? $('select[name="' + bs_fields[e] + '"]').selectpicker("val", "") : ($('input[name="' + bs_fields[e] + '"]').val(""), $('textarea[name="' + bs_fields[e] + '"]').val("")), "billing_country" == bs_fields[e] && ($('input[name="include_shipping"]').prop("checked", !1), $('input[name="include_shipping"]').change());
...
function init_billing_and_shipping_details() {
	...
	for (var a in bs_fields) e = "", e = bs_fields[a].indexOf("country") > -1 ? $("#" + bs_fields[a] + " option:selected").data("subtext") : bs_fields[a].indexOf("shipping_street") > -1 || bs_fields[a].indexOf("billing_street") > -1 ? $('textarea[name="' + bs_fields[a] + '"]').val().replace(/(?:\r\n|\r|\n)/g, "<br />") : $('input[name="' + bs_fields[a] + '"]').val(), bs_fields[a].indexOf("shipping") > -1 && (t || (e = "")), void 0 === e && (e = ""), e = "" != e ? e : "--", $("." + bs_fields[a]).html(e);
		...
		return get_taxes_dropdown_template(d, e.taxname).done(function (a) {
			...
			i.length > 0 && $.each(i, function () {
				...
				if (a.is(":checkbox")) {
					...
					c.attr("name", i);
					var p = c.clone();
					_.append(p), $.each(r, function (e, t) {
						_.find('select option[value="' + t + '"]').attr("selected", !0)
					}), t = _.html()
				}
...
function calculate_total() {
	var e, t, a, i, n, s, o = {},
		...
		r = 1,
		c = 0,
		_ = $(".table.table-main-invoice-edit tbody tr.item,.table.table-main-estimate-edit tbody tr.item,.table.table-main-credit-note-edit tbody tr.item"),
		p = $("#discount_area"),
	...
	$(".tax-area").remove(), $.each(_, function () {
		"" == (r = $(this).find("[data-quantity]").val()) && (r = 1, $(this).find("[data-quantity]").val(1)), n = accounting.toFixed($(this).find("td.rate input").val() * r, app_decimal_places), n = parseFloat(n), $(this).find("td.amount").html(accounting.formatNumber(n)), l += n, i = $(this), (a = $(this).find("select.tax").selectpicker("val")) && $.each(a, function (a, l) {
			t = i.find('select.tax [value="' + l + '"]').data("taxrate"), e = n / 100 * t, o.hasOwnProperty(l) ? o[l] = o[l] += e : 0 != t && (s = l.split("|"), tax_row = '<tr class="tax-area"><td>' + s[0] + "(" + t + '%)</td><td id="tax_id_' + slugify(l) + '"></td></tr>', $(p).after(tax_row), o[l] = e)
		})
...
function init_invoices_total(e) {
	if (0 != $("#invoices_total").length) {
		var t = $(".invoices-total-inline"),
			a = $(".invoices-total");
		if (!$("body").hasClass("invoices_total_manual") || void 0 !== e || a.hasClass("initialized"))
...
function init_estimates_total(e) {
	if (0 != $("#estimates_total").length) {
		...
		if (!$("body").hasClass("estimates_total_manual") || void 0 !== e || t.hasClass("initialized")) {
...
function proposal_pipeline_open(e) {
	"" != e && requestGet("proposals/pipeline_open/" + e).done(function (e) {
		$("#proposal").html(e), 0 == $(".proposal-pipeline-modal:visible").length ? $(".proposal-pipeline-modal").modal({
			show: !0,
			backdrop: "static",
			keyboard: !1
...
function estimate_pipeline_open(e) {
	"" != e && requestGet("estimates/pipeline_open/" + e).done(function (e) {
		$("#estimate").html(e), 0 == $(".estimate-pipeline:visible").length ? $(".estimate-pipeline").modal({
			show: !0,
			backdrop: "static",
			keyboard: !1
...
function small_table_full_view() {
	$("#small-table").toggleClass("hide"), $(".small-table-right-col").toggleClass("col-md-12 col-md-7")
}
...
function do_prefix_year(e) {
	var t;
	e.indexOf(".") > -1 ? t = e.split(".") : e.indexOf("-") > -1 ? t = e.split("-") : e.indexOf("/") > -1 && (t = e.split("/")), void 0 !== t && $.each(t, function (e, a) {
		if (4 == a.length) {
			var i = $("#prefix_year");
...
function view_meeting(e) {
	
	void 0 !== e && $.post(admin_url + "utilities/view_meeting/" + e).done(function (e) {
		$("#event").html(e), $("#meeting-modal").modal("show"), init_datepicker(), init_selectpicker(), validate_calendar_form()
	})
}
...
function calendar_form_handler(e) {
	return $.post(e.action, $(e).serialize()).done(function (e) {
		1 == (e = JSON.parse(e)).success && (alert_float("success", e.message), setTimeout(function () {
...
$(window).on("load", function () {
	...
	highlight: function (e) {
		...
		t.length && !t.is(":visible") && $('a[href="#' + t.attr("id") + '"]').css("border-bottom", "1px solid red").css("color", "red").addClass("tab-validation"), $(e).closest(".form-group").addClass("has-error")
	},
	...
	errorPlacement: function (e, t) {
		t.parent(".input-group").length || t.parents(".chk").length ? t.parents(".chk").length ? e.insertAfter(t.parents(".chk")) : e.insertAfter(t.parent()) : e.insertAfter(t)
	}
...
}, $.validator.format(appLang.validation_extension_not_allowed)), $("body").on("loaded.bs.select change", "select.ajax-search", function (e) {
	if ($(this).selectpicker("val")) {
		var t = $(this).parents(".bootstrap-select.ajax-search");
		0 === t.find(".ajax-clear-values").length && t.addClass("ajax-remove-values-option").find("button.dropdown-toggle").after('<span class="pointer ajax-clear-values" onclick="deselect_ajax_search(this); return false;" data-id="' + $(this).attr("id") + '"><i class="fa fa-remove"></i></span>')
	}
...
$(window).on("load resize", function (e) {
	...
	total_unread_notifications > 0 && (document.title = "(" + total_unread_notifications + ") " + doc_initial_title), $(".screen-options-btn").on("click", function () {
		...
		if (e.is(":visible")) convert_lead_to_customer(e.find('input[name="leadid"]').val());
			...
			a.is(":visible") || a.css("display", "block"), t.find("#task_comment").click()
	...
	}), custom_fields_hyperlink(), init_lightbox(), init_progress_bars(), init_datepicker(), $("body").on("loaded.bs.select", "._select_input_group", function (e) {
	...
	var t = side_bar.find("li > a");
	if ($.each(t, function (e, t) {
			var a = $(t).attr("href");
			if (location == a) {
				var i = side_bar.find('a[href="' + a + '"]');
				i.parents("li").not(".quick-links").addClass("active"), i.prop("aria-expanded", !0), i.parents("ul.nav-second-level").prop("aria-expanded", !0), i.parents("li").find("a:first-child").prop("aria-expanded", !0)
			}
		}), setup_menu.hasClass("display-block")) {
		var a = setup_menu.find("li > a");
		$.each(a, function (e, t) {
			var a = $(t).attr("href");
			if (location == a) {
				var i = setup_menu.find('a[href="' + a + '"]');
				i.parents("li").addClass("active"), i.prev("active"), i.parents("ul.nav-second-level").prop("aria-expanded", !0), i.parents("li").find("a:first-child").prop("aria-expanded", !0)
			}
		})
	}
	if (side_bar.metisMenu(), setup_menu.metisMenu(), $(".hide-menu").click(function (e) {
			e.preventDefault(), $(window).width() < 769 ? $("body").toggleClass("show-sidebar") : $("body").toggleClass("hide-sidebar"), setup_menu.hasClass("display-block") && $(".close-customizer").click()
			...
			$(this).trigger("keyup")
		}), mainWrapperHeightFix(), $("#search_input").on("keyup paste" + ("safari" == app_user_browser ? " input" : ""), function () {
			var e = $(this).val().trim(),
				t = $("#search_results"),
			...
			if ("13" == e.which) return $(this).focusout(), add_task_checklist_item($(this).attr("data-taskid")), !1
		}), $("body").on("blur paste", 'textarea[name="checklist-description"]', function () {
			var e = $(this),
				t = e.val();
			t = t.trim();
			var a = e.parents(".checklist").data("checklist-id");
			$.post(admin_url + "tasks/update_checklist_item", {
				description: t,
				listid: a
			}).done(function (i) {
				!0 === (i = JSON.parse(i)).can_be_template && e.parents(".checklist").find(".save-checklist-template").removeClass("hide"), "" === t && $("#checklist-items").find('.checklist[data-checklist-id="' + a + '"]').remove()
			})
		}), $("body").on("rendered.bs.select,refreshed.bs.select", "select.checklist-items-template-select", function () {
			"1" == has_permission_tasks_checklist_items_delete && setTimeout(function () {
				var e = $("body").find(".checklist-items-template-select ul.dropdown-menu li").not(":first-child"),
					t = $("body").find(".checklist-items-template-select select option").not(":first-child");
				$.each(t, function (t, a) {
					var i = $(a);
			...
			0 == e.length || 1 == e.length && "" == e[0] ? $(this).selectpicker("val", "") : e.length > 1 && "" == e[0] && (e.splice(0, 1), $(this).selectpicker("val", e))
			...
			var e = $(this).val();
			add_task_checklist_item($("#task-modal").find("[data-task-single-id]").attr("data-task-single-id"), $(this).find('option[value="' + e + '"]').html().trim()), $(this).selectpicker("val", "")
			...
			var e = $.trim($(this).text()),
				t = $("#leads-filter-status select");
			t.selectpicker("val", "");
			var a = [];
			t.find("option").filter(function () {
				this.text == e && a.push($(this).attr("value"))
			}), t.selectpicker("val", a), t.selectpicker("refresh"), table_leads.DataTable().ajax.reload()
		}), $("[data-can-view-own],[data-can-view]").on("change", function () {
			var e = $(this).attr("data-can-view-own");
			view_chk_selector = $(this).parents("tr").find("td input[" + (void 0 !== e && !1 !== e ? "data-can-view" : "data-can-view-own") + "]"), view_chk_selector.prop("checked", !1), !0 === $(this).prop("checked") ? view_chk_selector.prop("disabled", !0) : view_chk_selector.prop("disabled", !1)
			...
			tinymce.editors.task_comment && tinymce.remove("#task_comment"), init_editor("#task_comment", _simple_editor_config())
			...
			if ("" != t && "" != a || "" != i) {
				...
				n.timesheet_duration = i, n.start_time = t, n.end_time = a, n.timesheet_task_id = $(this).data("task-id"), n.note = $("body").find("#task_single_timesheet_note").val(), n.timesheet_staff_id = $("body").find('#task-modal select[name="single_timesheet_staff_id"]').val(), $.post(admin_url + "tasks/log_time", n).done(function (e) {
					1 == (e = JSON.parse(e)).success ? (init_task_modal(n.timesheet_task_id), alert_float("success", e.message), setTimeout(function () {
						reload_tasks_tables()
			...
			var e = {};
			return e.copy_from = $(this).data("task-copy-from"), e.copy_task_assignees = $("body").find("#copy_task_assignees").prop("checked"), e.copy_task_followers = $("body").find("#copy_task_followers").prop("checked"), e.copy_task_checklist_items = $("body").find("#copy_task_checklist_items").prop("checked"), e.copy_task_attachments = $("body").find("#copy_task_attachments").prop("checked"), e.copy_task_status = $("body").find('input[name="copy_task_status"]:checked').val(), $.post(admin_url + "tasks/copy", e).done(function (e) {
				if (1 == (e = JSON.parse(e)).success) {
					var t = $("#_task_modal");
			...
			setTimeout(function () {
				"undefined" != typeof task_track_chart && task_track_chart.destroy(), task_track_chart = new Chart(e, {
					type: "line",
		...
		if ($("body").hasClass("dashboard") && (i.customButtons.viewFullCalendar = {
				text: appLang.calendar_expand,
				click: function () {
					window.location.href = admin_url + "utilities/calendar"
				}
			}), i.customButtons.calendarFilter = {
				text: appLang.filter_by.toLowerCase(),
				click: function () {
					slideToggle("#calendar_filters")
				}
			}, 1 == is_staff_member && ("" != google_api && (i.googleCalendarApiKey = google_api), "" != calendarIDs && (calendarIDs = JSON.parse(calendarIDs), 0 != calendarIDs.length)))
			if ("" != google_api)
				for (var n = 0; n < calendarIDs.length; n++) {
					var s = {};
					s.googleCalendarId = calendarIDs[n], i.eventSources.push(s)
		...
		calendar_selector.fullCalendar(i), get_url_param("new_event") && ($("input[name='start'].datetimepicker").val(get_url_param("date")), $("#newEventModal").modal("show"))
	}
	$("body").on("change", 'select[name="tax"]', function () {
		...
		custom_fields_hyperlink(), 0 == $("body").find('#lead-modal input[name="leadid"]').length && $("body").find('#lead-modal input[name="name"]').focus()
	...
	$("body").on("click", ".add_more_attachments", function () {
		...
		t.find("input").removeAttr("aria-describedby aria-invalid"), t.find(".has-error").removeClass("has-error"), t.find("input").attr("name", "attachments[" + o + "]").val(""), t.find('p[id*="error"]').remove(), t.find("i").removeClass("fa-plus").addClass("fa-minus"), t.find("button").removeClass("add_more_attachments").addClass("remove_attachment").removeClass("btn-success").addClass("btn-danger"), o++
		...
		"#tab_lead_profile" == this.hash || "#attachments" == this.hash || "#lead_notes" == this.hash || "#lead_activity" == this.hash ? window.location.hash = this.hash : history.pushState("", document.title, window.location.pathname + window.location.search), $(document).resize()
	...
	if ((table_leads = $("table.table-leads")).length) {
		var d = table_leads.find("th");
		initDataTable(table_leads, admin_url + "leads/table", [d.length - 1, 0], [d.length - 1, 0], l, [1, "DESC"]), $.each(l, function (e, t) {
	...
	if ($("body").on("change", 'input[name="contacted_today"]', function () {
			...
			var e = $("#bulk_change");
			1 == $(this).prop("checked") && e.find("select").selectpicker("val", ""), e.toggleClass("hide"), $(".mass_delete_separator").toggleClass("hide")
			...
			var e = $(this).val();
			"custom" == e ? $(".recurring_custom").removeClass("hide") : $(".recurring_custom").addClass("hide"), "" != e && 0 != e ? $("body").find("#recurring_ends_on").removeClass("hide") : ($("body").find("#recurring_ends_on").addClass("hide"), $("body").find("#recurring_ends_on input").val(""))
			...
			notifications_wrapper.find(".notifications").attr("data-total-unread") > 0 && $.post(admin_url + "misc/set_notifications_read").done(function (e) {
				1 == (e = JSON.parse(e)).success && (document.title = doc_initial_title, $(".icon-notifications").addClass("hide"))
			})
		}), init_table_tickets(), init_table_announcements(), init_table_staff_projects(),init_table_staff_leads(), (table_activity_log = $("table.table-activity-log")).length) {
		var r = [];
		r.activity_log_date = '[name="activity_log_date"]', initDataTable(table_activity_log, window.location.href, "undefined", "undefined", r, [1, "DESC"])
	}
	if (table_invoices = $("table.table-invoices"), table_estimates = $("table.table-estimates"), table_invoices.length > 0 || table_estimates.length > 0) {
		var c = {},
			_ = $("._hidden_inputs._filters input");
		$.each(_, function () {
			c[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
		}), table_invoices.length && initDataTable(table_invoices, admin_url + "invoices/table", "undefined", "undefined", c, [
			[3, "DESC"],
			[0, "DESC"]
		]), table_estimates.length && initDataTable(table_estimates, admin_url + "estimates/table", "undefined", "undefined", c, [
			[3, "DESC"],
			[0, "DESC"]
		])
	}
	if ((table_tasks = $(".table-tasks")).length) {
		var p, m = {};
		p = $("._hidden_inputs._filters._tasks_filters input"), $.each(p, function () {
			m[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
		});
		var u = [table_tasks.find("th").length - 1],
			f = admin_url + "tasks/table";
		$("body").hasClass("tasks_page") && (u.push(0), f += "?bulk_actions=true"), _table_api = initDataTable(table_tasks, f, u, u, m, [table_tasks.find("th.duedate").index(), "ASC"]), _table_api && $("body").hasClass("dashboard") && _table_api.column(3).visible(!1, !1).column(4).visible(!1, !1).column(table_tasks.find(".table-tasks-options").index()).visible(!1, !1).columns.adjust()
	}
	...
	var h = $(".todos-sortable");
	h.length > 0 && (h = h.sortable({
		connectWith: ".todo",
		items: "li",
		handle: ".dragger",
		appendTo: "body",
		...
		var e = $(this).val();
		null != e && e.indexOf("all") > -1 && e.length > 1 && (e.splice(0, 1), $(this).selectpicker("val", e))
		...
		if ("" != e.find('textarea[name="description"]').val()) return $.post(e.attr("action"), $(e).serialize()).done(function (t) {
			e.find('textarea[name="description"]').val(""), e.hasClass("estimate-notes-form") ? get_sales_notes(t, "estimates") : e.hasClass("invoice-notes-form") && get_sales_notes(t, "invoices")
		}), !1
		...
		if (do_prefix_year(e), !($('input[name="isedit"]').length > 0)) {
			...
			$("body").find("div.estimate").length > 0 && (a = admin_url + "estimates/get_due_date", t = "expirydate"), "" == e && $('input[name="' + t + '"]').val(""), "" != e && $.post(a, {
				date: e
			}).done(function (e) {
		...
		1 == $(this).prop("checked") ? e.removeClass("hide") : e.addClass("hide")
		...
		requestGetJSON("invoices/client_change_data/" + e + "/" + (n = void 0 === n ? "" : n)).done(function (e) {
			...
			for (var n in bs_fields) bs_fields[n].indexOf("billing") > -1 && (bs_fields[n].indexOf("country") > -1 ? $('select[name="' + bs_fields[n] + '"]').selectpicker("val", e.billing_shipping[0][bs_fields[n]]) : bs_fields[n].indexOf("billing_street") > -1 ? $('textarea[name="' + bs_fields[n] + '"]').val(e.billing_shipping[0][bs_fields[n]]) : $('input[name="' + bs_fields[n] + '"]').val(e.billing_shipping[0][bs_fields[n]]));
			empty(e.billing_shipping[0].shipping_street) || $('input[name="include_shipping"]').prop("checked", !0).change();
			for (var n in bs_fields) bs_fields[n].indexOf("shipping") > -1 && (bs_fields[n].indexOf("country") > -1 ? $('select[name="' + bs_fields[n] + '"]').selectpicker("val", e.billing_shipping[0][bs_fields[n]]) : bs_fields[n].indexOf("shipping_street") > -1 ? $('textarea[name="' + bs_fields[n] + '"]').val(e.billing_shipping[0][bs_fields[n]]) : $('input[name="' + bs_fields[n] + '"]').val(e.billing_shipping[0][bs_fields[n]]));
			init_billing_and_shipping_details();
	...
	}), 0 == $('input[name="isedit"]').length && $('.f_client_id select[name="clientid"]').change(), $("body").on("click", "#get_shipping_from_customer_profile", function (e) {
		e.preventDefault();
		var t = $("#include_shipping");
		0 == t.prop("checked") && (t.prop("checked", !0), $("#shipping_details").removeClass("hide"));
		...
		var e = $(this).prop("checked"),
			t = $(this).val();
		1 == e ? requestGetJSON("invoices/get_merge_data/" + t).done(function (e) {
		...
		var e = $(this).prop("checked"),
			t = $(this).val();
		1 == e ? requestGetJSON("invoices/get_bill_expense_data/" + t).done(function (e) {
		...
		current_desc_val = a.val(), current_desc_val = current_desc_val.trim(), "" != t && (1 == $(this).prop("checked") ? (e = current_desc_val + "\n" + t, a.val(e.trim())) : (a.val(current_desc_val.replace("\n" + t, "")), a.val(current_desc_val.replace(t, ""))))
	})
